...
with webdriver.Chrome(service=ChromeService(ChromeDriverManager().install())) as driver:
    ...
    try:
        ...
        WebDriverWait(driver, 10).until(EC.presence_of_element_located((By.ID, "otp-username"))).send_keys(USERNAME)
        time.sleep(4)
        ...
        WebDriverWait(driver, 10).until(EC.url_contains("/my/resumes"))
